...
class Simulation:
    ...
    def run(self, situation):
        ...
        if situation == 1:
            ...
            self.cars.append(OBU("car_merge", 5, "192.168.98.13", 5, 2, Navigation(routes, "lane_merge"), random.randint(50, 80)))
            self.cars.append(OBU("car_1", 2, "192.168.98.10", 5, 2, Navigation(routes, route_names[random.randint(0, 1)]), random.randint(50, 80)))
            self.cars.append(OBU("car_2", 3, "192.168.98.11", 5, 2, Navigation(routes, route_names[random.randint(0, 1)]), random.randint(50, 80)))
            self.cars.append(OBU("car_3", 4, "192.168.98.12", 5, 2, Navigation(routes, route_names[random.randint(0, 1)]), random.randint(50, 80)))
